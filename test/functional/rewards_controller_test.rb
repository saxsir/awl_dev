...
class RewardsControllerTest < ActionController::TestCase
  ...
  test "should create reward" do
    assert_difference('Reward.count') do
      post :create, reward: { description: @reward.description, project_id: @reward.project_id, title: @reward.title }
    end
  ...
  test "should update reward" do
    put :update, id: @reward, reward: { description: @reward.description, project_id: @reward.project_id, title: @reward.title }
    assert_redirected_to reward_path(assigns(:reward))
  end

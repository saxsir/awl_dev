...
class SupportsControllerTest < ActionController::TestCase
  ...
  test "should create support" do
    assert_difference('Support.count') do
      post :create, support: { amount: @support.amount, project_id: @support.project_id, reward_id: @support.reward_id, user_id: @support.user_id }
    end
  ...
  test "should update support" do
    put :update, id: @support, support: { amount: @support.amount, project_id: @support.project_id, reward_id: @support.reward_id, user_id: @support.user_id }
    assert_redirected_to support_path(assigns(:support))
  end
